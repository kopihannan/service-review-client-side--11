    ...
    return (
        <div className="navbar bg-base-100 py-6">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <Link className='font-semibold mr-7 hover:text-lime-600'>Home</Link>
                        <Link className='font-semibold mr-7 hover:text-lime-600'>Services</Link>
                ...
                <div className='flex items-center'>
                    ...
                    <Link className="text-3xl font-bold font-serif">VROMON</Link>
                </div>
            </div>
            ...
            <div className="navbar-end">
                <Link className="font-semibold">Login</Link>
            </div>
        </div>
    );
};
